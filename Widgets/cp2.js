...
async function loadPage(params) {
  ...
  // 如果 url 已经包含参数，则追加；否则拼接
  var fullUrl = url.indexOf('?') !== -1 ? appendParams(url, queryParams) : url + '?' + new URLSearchParams(queryParams).toString();
